...
(function(window) {
    ...
    var cookieChoices = (function() {
        ...
        function _createHeaderElement(cookieText, dismissText, linkText, linkHref) {
            var butterBarStyles = 'position:fixed;width:100%;background-color:#464a4e;color:white;' +
        ...
        function _loadScripts() {
            // document.cookie.indexOf("displayCookieConsent=y") == -1
            if(typeof loadScripts == 'function' && scripts_loaded === false){
                scripts_loaded = true;
                loadScripts();
            }
        }
        ...
        exports.onScrollDismiss = onScrollDismiss;
        return exports;
    })();
